...
<section class="form-container mx-auto max-w-md p-6 bg-white rounded-lg shadow-lg">
   ...
   <form action="" method="post">
      ...
      <input type="email" name="email" required placeholder="Enter your email" class="w-full p-2 border border-gray-300 rounded mb-2" maxlength="50">
      <input type="password" name="pass" required placeholder="Enter your password" class="w-full p-2 border border-gray-300 rounded mb-2" maxlength="50">
