        ...
        <div class="max-w-md w-full p-4 bg-white rounded shadow-lg">
            <form action="" method="post" class="space-y-4 p-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <input type="text" class="input" placeholder="Nomor Bangunan" required maxlength="50"
                        name="building">
                    <input type="text" class="input" placeholder="Kota" required maxlength="50" name="city">
                    <input type="number" class="input" placeholder="Kode Pos" required max="999999" min="0"
                        maxlength="6" name="pin_code">
                </div>
                <button type="submit" name="submit" class="btn w-full hover:bg-blue-100">Save Address</button>
            </form>
        </div>
    </section>
